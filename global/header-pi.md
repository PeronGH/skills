...
- Never call Bash tool with prefixed `cd <cwd> && ...`. Just run commands directly and use paths relative to the current working directory. Use relative paths in other tools too.
