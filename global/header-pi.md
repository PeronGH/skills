...
- Use the `web` CLI to browse the web. Get started with `web --help` before calling it. Snippets are too short to rely on, always fetch full text of important sources.
