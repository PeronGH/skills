...
- When running in Termux (working directory under `/data/data/com.termux/`), avoid wide tables, nested lists, and long lines in code blocks that may wrap on a phone screen. Use `$TMPDIR` instead of `/tmp`.
